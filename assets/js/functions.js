...
(function(_0x5e5bx1) {
    ...
    _0x5e5bx1('#password1, #password2')['hidePassword']('focus', {
        toggle: {
            className: 'my-toggle'
        }
    });
    ...
    _0x5e5bx1('a[href^="#"].mobile_btn')['on']('click', function(_0x5e5bx5) {
        ...
        _0x5e5bx1('html, body')['stop']()['animate']({
            "\x73\x63\x72\x6F\x6C\x6C\x54\x6F\x70": _0x5e5bx7['offset']()['top']
        }, 400, 'swing', function() {
            window['location']['hash'] = _0x5e5bx6
        })
    });
    var _0x5e5bx8 = _0x5e5bx1('.cd-overlay-nav'),
        _0x5e5bx9 = _0x5e5bx1('.cd-overlay-content'),
        _0x5e5bxa = _0x5e5bx1('.cd-primary-nav'),
        _0x5e5bxb = _0x5e5bx1('.cd-nav-trigger');
    _0x5e5bxc();
    ...
    _0x5e5bxb['on']('click', function() {
        if (!_0x5e5bxb['hasClass']('close-nav')) {
            ...
            _0x5e5bx8['children']('span')['velocity']({
                translateZ: 0,
                scaleX: 1,
                scaleY: 1
            ...
            _0x5e5bx9['children']('span')['velocity']({
                translateZ: 0,
                scaleX: 1,
                scaleY: 1
            }, 500, 'easeInCubic', function() {
