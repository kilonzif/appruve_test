!function (t, e) {
    ...
    function y(t) {
        ...
        var e = _(t), i = e.overflow, s = e.overflowX, n = e.overflowY;
    ...
    function x() {
        var t = window.document.body, e = window.document.documentElement, i = j() && window.getComputedStyle(e);
    ...
    function I(t, e) {
        var i = j(), s = "HTML" === e.nodeName, n = E(t), o = E(e), r = y(t), a = _(e),
            l = +a.borderTopWidth.split("px")[0], h = +a.borderLeftWidth.split("px")[0],
            c = k({top: n.top - o.top - l, left: n.left - o.left - h, width: n.width, height: n.height});
        if (c.marginTop = 0, c.marginLeft = 0, !i && s) {
            var u = +a.marginTop.split("px")[0], d = +a.marginLeft.split("px")[0];
        ...
        return (i ? e.contains(r) : e === r && "BODY" !== r.nodeName) && (c = function (t, e) {
            var i = 2 < arguments.length && void 0 !== arguments[2] && arguments[2], s = D(e, "top"), n = D(e, "left"),
                o = i ? -1 : 1;
    ...
    function d(t, e, i, s) {
        var n, o, r, a, l, h, c, u = {top: 0, left: 0}, d = C(t, e);
    ...
    function a(t, e, s, i, n) {
        ...
        var r = d(s, i, o, n), a = {
            ...
            return Y({key: t}, a[t], {area: (e = a[t], e.width * e.height)});
            var e
        }).sort(function (t, e) {
    ...
    function T(t, e, i) {
        i = i.split("-")[0];
        var s = f(t), n = {width: s.width, height: s.height}, o = -1 !== ["right", "left"].indexOf(i),
    ...
    function h(i, s) {
        Object.keys(s).forEach(function (t) {
            var e = "";
            -1 !== ["width", "height", "top", "right", "bottom", "left"].indexOf(t) && p(s[t]) && (e = "px"), i.style[t] = s[t] + e
        })
    }
    ...
    for (var v = Math.min, M = Math.floor, N = Math.max, o = ["native code", "[object MutationObserverConstructor]"], O = "undefined" != typeof window, z = ["Edge", "Trident", "Firefox"], H = 0, W = 0; W < z.length; W += 1) if (O && 0 <= navigator.userAgent.indexOf(z[W])) {
        H = 1;
        break
    }
    var $, L, R = O && (L = window.MutationObserver, o.some(function (t) {
            ...
            var e = !1, i = 0, s = document.createElement("span");
            return new MutationObserver(function () {
                t(), e = !1
            }).observe(s, {attributes: !0}), function () {
        ...
        U = K.slice(3), Q = "flip", V = "clockwise", X = "counterclockwise", Z = function () {
            function o(t, e) {
        ...
        modifiers: {
            shift: {
                order: 100, enabled: !0, fn: function (t) {
                    ...
                    if (s) {
                        var n = t.offsets, o = n.reference, r = n.popper, a = -1 !== ["bottom", "top"].indexOf(i),
                            ...
                            c = {start: B({}, l, o[l]), end: B({}, l, o[l] + o[h] - r[h])};
                ...
                order: 200, enabled: !0, fn: function (t, e) {
                    var i, s = e.offset, n = t.placement, o = t.offsets, r = o.popper, a = o.reference,
                        l = n.split("-")[0];
                ...
                order: 300, enabled: !0, fn: function (t, s) {
                    ...
                    s.boundaries = n;
                    var i = s.priority, o = t.offsets.popper, r = {
                        primary: function (t) {
                            var e = o[t];
                            return o[t] < n[t] && !s.escapeWithReference && (e = N(o[t], n[t])), B({}, t, e)
                        }, secondary: function (t) {
                            var e = "right" === t ? "left" : "top", i = o[e];
                ...
                order: 400, enabled: !0, fn: function (t) {
                    var e = t.offsets, i = e.popper, s = e.reference, n = t.placement.split("-")[0], o = M,
                ...
                order: 500, enabled: !0, fn: function (t, e) {
                    ...
                    var s = t.placement.split("-")[0], n = t.offsets, o = n.popper, r = n.reference,
                        a = -1 !== ["left", "right"].indexOf(s), l = a ? "height" : "width", h = a ? "top" : "left",
                        c = a ? "left" : "top", u = a ? "bottom" : "right", d = f(i)[l];
                ...
                order: 600, enabled: !0, fn: function (f, g) {
                    ...
                    var m = d(f.instance.popper, f.instance.reference, g.padding, g.boundariesElement),
                        v = f.placement.split("-")[0], _ = S(v), b = f.placement.split("-")[1] || "", y = [];
                    switch (g.behavior) {
                        case Q:
                            y = [v, _];
                            break;
                    ...
                    return y.forEach(function (t, e) {
                        ...
                        var i, s = f.offsets.popper, n = f.offsets.reference, o = M,
                            r = "left" === v && o(s.right) > o(n.left) || "right" === v && o(s.left) < o(n.right) || "top" === v && o(s.bottom) > o(n.top) || "bottom" === v && o(s.top) < o(n.bottom),
                            a = o(s.left) < o(m.left), l = o(s.right) > o(m.right), h = o(s.top) < o(m.top),
                ...
                order: 800, enabled: !0, fn: function (t) {
                    ...
                    var e = t.offsets.reference, i = A(t.instance.modifiers, function (t) {
                ...
                order: 850, enabled: !0, fn: function (t, e) {
                    var i = e.x, s = e.y, n = t.offsets.popper, o = A(t.instance.modifiers, function (t) {
                        return "applyStyle" === t.name
                    }).gpuAcceleration;
                    void 0 !== o && console.warn("WARNING: `gpuAcceleration` option moved to `computeStyle` modifier and will not be supported in future versions of Popper.js!");
                    var r, a, l = void 0 === o ? e.gpuAcceleration : o, h = E(w(t.instance.popper)),
                        c = {position: n.position},
                        u = {left: M(n.left), top: M(n.top), bottom: M(n.bottom), right: M(n.right)},
                        d = "bottom" === i ? "top" : "bottom", p = "right" === s ? "left" : "right", f = F("transform");
                    if (a = "bottom" == d ? -h.height + u.bottom : u.top, r = "right" == p ? -h.width + u.right : u.left, l && f) c[f] = "translate3d(" + r + "px, " + a + "px, 0)", c[d] = 0, c[p] = 0, c.willChange = "transform"; else {
                        var g = "bottom" == d ? -1 : 1, m = "right" == p ? -1 : 1;
    ...
    var n, i, o, a, h, u, d, p, f, g, m, v, _, b, y, w, C, D, x, k, E, I, S, T, A, P, F, M, N, O, z, H, W, $, L, R, j,
        q, B, Y, K, U, Q, V, X, Z, G, J, tt, et, it, st, nt, ot, rt, at, lt, ht, ct, ut, dt, pt, ft, gt, mt, vt, _t, bt,
        yt, wt, Ct, Dt, xt, kt, Et, It, St, Tt, At, Pt, Ft, Mt, Nt, Ot, zt, Ht, Wt, $t, Lt, Rt, jt, qt, Bt, Yt, Kt, Ut,
        Qt, Vt, Xt, Zt, Gt, Jt, te, ee, ie, se, ne, oe, re, ae, le, he, ce, ue, de, pe, fe, ge, me, ve, _e, be, ye, we,
        Ce, De, xe, ke, Ee, Ie, Se, Te, Ae, Pe, Fe, Me, Ne, Oe, ze, He, We, $e, Le, Re, je, qe, Be, Ye, Ke, Ue, Qe, Ve,
        Xe, Ze, Ge, Je, ti, ei, ii, si, ni, oi, ri, ai, li, hi, ci, ui, di, pi, fi, gi, mi, vi, _i, bi, yi, wi, Ci, Di,
        xi, ki, Ei, Ii, Si, Ti, Ai, Pi, Fi, Mi, Ni, Oi, zi, Hi, Wi, $i, Li = function (s) {
            var e = "transitionend";
        ...
        }(e), Ri = (i = "alert", a = "." + (o = "bs.alert"), h = (n = e).fn[i], u = {
            CLOSE: "close" + a,
            CLOSED: "closed" + a,
            ...
            return t.close = function (t) {
                ...
                var e = Li.getSelectorFromElement(t), i = !1;
        ...
        ji = (v = "button", b = "." + (_ = "bs.button"), y = ".data-api", w = (m = e).fn[v], C = "active", D = "btn", k = '[data-toggle^="button"]', E = '[data-toggle="buttons"]', I = "input", S = ".active", T = ".btn", A = {
            ...
            return t.toggle = function () {
                var t = !0, e = !0, i = m(this._element).closest(E)[0];
                if (i) {
                    var s = this._element.querySelector(I);
                    if (s) {
                        if ("radio" === s.type) if (s.checked && this._element.classList.contains(C)) t = !1; else {
        ...
        }, P), qi = (M = "carousel", O = "." + (N = "bs.carousel"), z = ".data-api", H = (F = e).fn[M], W = {
            interval: 5e3,
            keyboard: !0,
            slide: !1,
            pause: "hover",
            ...
            return t.next = function () {
                ...
                if (!(t > this._items.length - 1 || t < 0)) if (this._isSliding) F(this._element).one(B.SLID, function () {
                    return e.to(t)
                }); else {
                ...
                var i = t === L, s = t === R, n = this._getItemIndex(e), o = this._items.length - 1;
                if ((s && 0 === n || i && n === o) && !this._config.wrap) return e;
                var r = (n + (t === R ? -1 : 1)) % this._items.length;
                return -1 === r ? this._items[this._items.length - 1] : this._items[r]
            }, t._triggerSlideEvent = function (t, e) {
                var i = this._getItemIndex(t), s = this._getItemIndex(this._element.querySelector(J)),
                    n = F.Event(B.SLIDE, {relatedTarget: t, direction: e, from: s, to: i});
                ...
                var i, s, n, o = this, r = this._element.querySelector(J), a = this._getItemIndex(r),
                    l = e || r && this._getItemByDirection(t, r), h = this._getItemIndex(l), c = Boolean(this._interval);
                if (t === L ? (i = V, s = X, n = j) : (i = Q, s = Z, n = q), l && F(l).hasClass(K)) this._isSliding = !1; else if (!this._triggerSlideEvent(l, n).isDefaultPrevented() && r && l) {
                    this._isSliding = !0, c && this.pause(), this._setActiveIndicatorElement(l);
                    var u = F.Event(B.SLID, {relatedTarget: l, direction: n, from: a, to: h});
                ...
                return this.each(function () {
                    var t = F(this).data(N), e = l({}, W, F(this).data());
                    "object" == typeof s && (e = l({}, e, s));
                    var i = "string" == typeof s ? s : e.slide;
                    if (t || (t = new o(this, e), F(this).data(N, t)), "number" == typeof s) t.to(s); else if ("string" == typeof i) {
        ...
        }, ot), Bi = (at = "collapse", ht = "." + (lt = "bs.collapse"), ct = (rt = e).fn[at], ut = {
            toggle: !0,
            parent: ""
            ...
            function a(e, t) {
                ...
                for (var i = [].slice.call(document.querySelectorAll(wt)), s = 0, n = i.length; s < n; s++) {
                    var o = i[s], r = Li.getSelectorFromElement(o),
            ...
            return t.toggle = function () {
                ...
                if (!this._isTransitioning && rt(this._element).hasClass(ft)) {
                    ...
                    if (rt(this._element).trigger(e), !e.isDefaultPrevented()) {
                        ...
                        if (0 < s) for (var n = 0; n < s; n++) {
                            var o = this._triggerArray[n], r = Li.getSelectorFromElement(o);
                ...
                return this.each(function () {
                    var t = rt(this), e = t.data(lt), i = l({}, ut, t.data(), "object" == typeof s && s ? s : {});
            ...
            var i = rt(this), e = Li.getSelectorFromElement(this), s = [].slice.call(document.querySelectorAll(e));
            rt(s).each(function () {
                var t = rt(this), e = t.data(lt) ? "toggle" : i.data();
        ...
        Yi = (xt = "dropdown", Et = "." + (kt = "bs.dropdown"), It = ".data-api", St = (Dt = e).fn[xt], Tt = new RegExp("38|40|27"), At = {
            ...
            return t.toggle = function () {
                if (!this._element.disabled && !Dt(this._element).hasClass(Pt)) {
                    var t = h._getParentFromElement(this._element), e = Dt(this._menu).hasClass(Ft);
                    if (h._clearMenus(), !e) {
                        var i = {relatedTarget: this._element}, s = Dt.Event(At.SHOW, i);
                ...
                var t = Dt(this._element.parentNode), e = Yt;
                ...
                if (!t || 3 !== t.which && ("keyup" !== t.type || 9 === t.which)) for (var e = [].slice.call(document.querySelectorAll(Wt)), i = 0, s = e.length; i < s; i++) {
                    var n = h._getParentFromElement(e[i]), o = Dt(e[i]).data(kt), r = {relatedTarget: e[i]};
                ...
                if ((/input|textarea/i.test(t.target.tagName) ? !(32 === t.which || 27 !== t.which && (40 !== t.which && 38 !== t.which || Dt(t.target).closest(Lt).length)) : Tt.test(t.which)) && (t.preventDefault(), t.stopPropagation(), !this.disabled && !Dt(this).hasClass(Pt))) {
                    var e = h._getParentFromElement(this), i = Dt(e).hasClass(Ft);
        ...
        }, Zt), Ki = (Jt = "modal", ee = "." + (te = "bs.modal"), ie = (Gt = e).fn[Jt], se = {
            backdrop: !0,
            keyboard: !0,
            focus: !0,
            show: !0
            ...
            return t.toggle = function (t) {
                ...
                if (!this._isTransitioning && !this._isShown) {
                    ...
                    var i = Gt.Event(oe.SHOW, {relatedTarget: t});
                ...
                var e = this, i = Gt(this._element).hasClass(he);
                ...
                var s = Gt.Event(oe.SHOWN, {relatedTarget: t}), n = function () {
                ...
                var e = this, i = Gt(this._element).hasClass(he) ? he : "";
                ...
                if (this._isBodyOverflowing) {
                    var t = [].slice.call(document.querySelectorAll(fe)), e = [].slice.call(document.querySelectorAll(ge));
                    Gt(t).each(function (t, e) {
                        var i = e.style.paddingRight, s = Gt(e).css("padding-right");
                        Gt(e).data("padding-right", i).css("padding-right", parseFloat(s) + n._scrollbarWidth + "px")
                    }), Gt(e).each(function (t, e) {
                        var i = e.style.marginRight, s = Gt(e).css("margin-right");
                        Gt(e).data("margin-right", i).css("margin-right", parseFloat(s) - n._scrollbarWidth + "px")
                    });
                    var i = document.body.style.paddingRight, s = Gt(document.body).css("padding-right");
                ...
                return this.each(function () {
                    var t = Gt(this).data(te), e = l({}, se, Gt(this).data(), "object" == typeof i && i ? i : {});
            ...
            var e, i = this, s = Li.getSelectorFromElement(this);
        ...
        Ui = (_e = "tooltip", ye = "." + (be = "bs.tooltip"), we = (ve = e).fn[_e], Ce = "bs-tooltip", De = new RegExp("(^|\\s)" + Ce + "\\S+", "g"), Ee = {
            ...
            title: "",
            delay: 0,
            html: !(ke = {AUTO: "auto", TOP: "top", RIGHT: "right", BOTTOM: "bottom", LEFT: "left"}),
            selector: !(xe = {
                animation: "boolean",
                template: "string",
            ...
            return t.enable = function () {
                ...
                if (this._isEnabled) if (t) {
                    var e = this.constructor.DATA_KEY, i = ve(t.currentTarget).data(e);
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    var s = this.getTipElement(), n = Li.getUID(this.constructor.NAME);
                ...
                var e = this, i = this.getTipElement(), s = ve.Event(this.constructor.Event.HIDE), n = function () {
                ...
                var t = ve(this.getTipElement()), e = t.attr("class").match(De);
                ...
                return this.each(function () {
                    var t = ve(this).data(be), e = "object" == typeof i && i;
        ...
        Qi = (Le = "popover", je = "." + (Re = "bs.popover"), qe = ($e = e).fn[Le], Be = "bs-popover", Ye = new RegExp("(^|\\s)" + Be + "\\S+", "g"), Ke = l({}, Ui.Default, {
        ...
        }), Ue = l({}, Ui.DefaultType, {content: "(string|element|function)"}), Qe = "fade", Xe = ".popover-header", Ze = ".popover-body", Ge = {
            HIDE: "hide" + je,
            HIDDEN: "hidden" + je,
            SHOW: (Ve = "show") + je,
            SHOWN: "shown" + je,
            ...
            return n.isWithContent = function () {
                ...
                var t = $e(this.getTipElement()), e = t.attr("class").match(Ye);
                null !== e && 0 < e.length && t.removeClass(e.join(""))
            }, s._jQueryInterface = function (i) {
                return this.each(function () {
                    var t = $e(this).data(Re), e = "object" == typeof i ? i : null;
        ...
        }, Je), Vi = (ei = "scrollspy", si = "." + (ii = "bs.scrollspy"), ni = (ti = e).fn[ei], oi = {
            offset: 10,
            method: "auto",
            target: ""
        }, ri = {offset: "number", method: "string", target: "(string|element)"}, ai = {
            ...
            return t.refresh = function () {
                var e = this, t = this._scrollElement === this._scrollElement.window ? bi : yi,
                    n = "auto" === this._config.method ? t : this._config.method, o = n === yi ? this._getScrollTop() : 0;
                ...
                i.hasClass(li) ? (i.closest(mi).find(_i).addClass(hi), i.addClass(hi)) : (i.addClass(hi), i.parents(di).prev(pi + ", " + gi).addClass(hi), i.parents(di).prev(fi).children(pi).addClass(hi)), ti(this._scrollElement).trigger(ai.ACTIVATE, {relatedTarget: e})
            }, t._clear = function () {
        ...
        }, wi), Xi = (xi = "." + (Di = "bs.tab"), ki = (Ci = e).fn.tab, Ei = {
            HIDE: "hide" + xi,
            HIDDEN: "hidden" + xi,
            SHOW: "show" + xi,
            SHOWN: "shown" + xi,
            ...
            return t.show = function () {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && Ci(this._element).hasClass(Si) || Ci(this._element).hasClass(Ti))) {
                    var t, s, e = Ci(this._element).closest(Mi)[0], n = Li.getSelectorFromElement(this._element);
                    if (e) {
                        var o = "UL" === e.nodeName ? Oi : Ni;
                        s = (s = Ci.makeArray(Ci(e).find(o)))[s.length - 1]
                    }
                    var r = Ci.Event(Ei.HIDE, {relatedTarget: this._element}), a = Ci.Event(Ei.SHOW, {relatedTarget: s});
                    if (s && Ci(s).trigger(r), Ci(this._element).trigger(a), !a.isDefaultPrevented() && !r.isDefaultPrevented()) {
                        ...
                        var l = function () {
                            var t = Ci.Event(Ei.HIDDEN, {relatedTarget: i._element}),
                                e = Ci.Event(Ei.SHOWN, {relatedTarget: s});
                ...
                var s = this, n = ("UL" === e.nodeName ? Ci(e).find(Oi) : Ci(e).children(Ni))[0],
                    o = i && n && Ci(n).hasClass(Ai), r = function () {
    ...
    }(e), t.Util = Li, t.Alert = Ri, t.Button = ji, t.Carousel = qi, t.Collapse = Bi, t.Dropdown = Yi, t.Modal = Ki, t.Popover = Qi, t.Scrollspy = Vi, t.Tab = Xi, t.Tooltip = Ui, Object.defineProperty(t, "__esModule", {value: !0})
}), function (a, t) {
    function s(t, e) {
    ...
    b.widget("ui.draggable", b.ui.mouse, {
        ...
        _generatePosition: function (t) {
            var e = this.options,
                ...
                s = /(html|body)/i.test(i[0].tagName), n = t.pageX, o = t.pageY;
        ...
        start: function (t, e) {
            ...
            for (var i = b(this).data("draggable"), s = i.options, n = s.snapTolerance, o = e.offset.left, r = o + i.helperProportions.width, a = e.offset.top, l = a + i.helperProportions.height, h = i.snapElements.length - 1; 0 <= h; h--) {
                var c = i.snapElements[h].left, u = c + i.snapElements[h].width, d = i.snapElements[h].top,
                ...
                if (c - n < o && o < u + n && d - n < a && a < p + n || c - n < o && o < u + n && d - n < l && l < p + n || c - n < r && r < u + n && d - n < a && a < p + n || c - n < r && r < u + n && d - n < l && l < p + n) {
                    if ("inner" != s.snapMode) {
                        var f = Math.abs(d - l) <= n, g = Math.abs(p - a) <= n, m = Math.abs(c - r) <= n,
                            v = Math.abs(u - o) <= n;
                    ...
                    !i.snapElements[h].snapping && (f || g || m || v || _) && i.options.snap.snap && i.options.snap.snap.call(i.element, t, b.extend(i._uiHash(), {snapItem: i.snapElements[h].item})), i.snapElements[h].snapping = f || g || m || v || _
        ...
        start: function (t, e) {
            var i = b(this).data("draggable").options, s = b.makeArray(b(i.stack)).sort(function (t, e) {
    ...
    f.widget("ui.resizable", f.ui.mouse, {
        ...
        _mouseStop: function (t) {
            ...
            if (this._helper) {
                var s = this._proportionallyResizeElements, n = s.length && /textarea/i.test(s[0].nodeName),
                    o = n && f.ui.hasScroll(s[0], "left") ? 0 : i.sizeDiff.height, r = n ? 0 : i.sizeDiff.width,
        ...
        _renderProxy: function () {
            ...
            if (this.elementOffset = t.offset(), this._helper) {
                ...
                var i = f.browser.msie && f.browser.version < 7, s = i ? 1 : 0, n = i ? 2 : -1;
        ...
        start: function (t, e) {
            var i = f(this).data("resizable").options, s = function (t) {
                f(t).each(function () {
                    var t = f(this);
            ...
            var e = f(this).data("resizable"), i = e.options, s = e.originalSize, n = e.originalPosition, r = {
        ...
        start: function (t, e) {
            var i = f(this).data("resizable"), s = i.options, n = i.element, o = s.containment,
                r = o instanceof f ? o.get(0) : /parent/.test(o) ? n.parent().get(0) : o;
            if (r) if (i.containerElement = f(r), /document/.test(o) || o == document) i.containerOffset = {
                left: 0,
                top: 0
                ...
                var h = i.containerOffset, c = i.containerSize.height, u = i.containerSize.width,
                    d = f.ui.hasScroll(r, "left") ? r.scrollWidth : u, p = f.ui.hasScroll(r) ? r.scrollHeight : c;
                i.parentData = {element: r, left: h.left, top: h.top, width: d, height: p}
            }
        }, resize: function (t, e) {
    ...
    h.widget("ui.selectable", h.ui.mouse, {
        options: {
            ...
            if (this.dragged = !0, !this.options.disabled) {
                var n = this.options, o = this.opos[0], r = this.opos[1], a = i.pageX, l = i.pageY;
                if (a < o) {
                    var t = a;
                    a = o, o = t
                }
    ...
    d.widget("ui.sortable", d.ui.mouse, {
        ...
        _mouseStop: function (t, e) {
            if (t) {
                if (d.ui.ddmanager && !this.options.dropBehaviour && d.ui.ddmanager.drop(this, t), this.options.revert) {
                    var i = this, s = i.placeholder.offset();
        ...
        _refreshItems: function (t) {
            ...
            for (n = i.length - 1; 0 <= n; n--) for (var l = i[n][1], h = i[n][0], c = (r = 0, h.length); r < c; r++) {
                var u = d(h[r]);
        ...
        _contactContainers: function (t) {
            ...
            if (e) if (1 === this.containers.length) this.containers[i]._trigger("over", t, this._uiHash(this)), this.containers[i].containerCache.over = 1; else if (this.currentContainer != this.containers[i]) {
                for (var n = 1e4, o = null, r = this.positionAbs[this.containers[i].floating ? "left" : "top"], a = this.items.length - 1; 0 <= a; a--) if (d.ui.contains(this.containers[i].element[0], this.items[a].item[0])) {
        ...
        _setContainment: function () {
            ...
            if ("parent" == t.containment && (t.containment = this.helper[0].parentNode), "document" != t.containment && "window" != t.containment || (this.containment = [0 - this.offset.relative.left - this.offset.parent.left, 0 - this.offset.relative.top - this.offset.parent.top, d("document" == t.containment ? document : window).width() - this.helperProportions.width - this.margins.left, (d("document" == t.containment ? document : window).height() || document.body.parentNode.scrollHeight) - this.helperProportions.height - this.margins.top]), !/^(document|window|parent)$/.test(t.containment)) {
                var e = d(t.containment)[0], i = d(t.containment).offset(), s = "hidden" != d(e).css("overflow");
    ...
    f.effects.bounce = function (p) {
        return this.queue(function () {
            ...
            ("show" == i && t.css("opacity", 0).css(a, "pos" == l ? -n : n), "hide" == i && (n /= 2 * o), "hide" != i && o--, "show" == i) && ((u = {opacity: 1})[a] = ("pos" == l ? "+=" : "-=") + n, t.animate(u, r / 2, p.options.easing), n /= 2, o--);
            for (var h = 0; h < o; h++) {
                var c = {};
            ...
            if ("hide" == i) {
                var u;
                (u = {opacity: 0})[a] = ("pos" == l ? "-=" : "+=") + n, t.animate(u, r / 2, p.options.easing, function () {
    ...
    g.effects.puff = function (o) {
        ...
        return this.queue(function () {
            var t = g(this),
                ...
                s = ["width", "height", "overflow"], n = ["fontSize"],
                o = ["borderTopWidth", "borderBottomWidth", "paddingTop", "paddingBottom"],
                r = ["borderLeftWidth", "borderRightWidth", "paddingLeft", "paddingRight"],
                a = g.effects.setMode(t, f.options.mode || "effect"), l = f.options.restore || !1,
                h = f.options.scale || "both", c = f.options.origin, u = {height: t.height(), width: t.width()};
            ...
            var p = {
                from: {y: t.from.height / u.height, x: t.from.width / u.width},
                to: {y: t.to.height / u.height, x: t.to.width / u.width}
            };
    ...
    d.widget("ui.accordion", {
        options: {
            ...
            if (!i.disabled) if (t.target) {
                var s = d(t.currentTarget || e), n = s[0] === this.active[0];
                if (i.active = (!i.collapsible || !n) && this.headers.index(s), !(this.running || !i.collapsible && n)) {
                    var o = this.active, r = (h = s.next(), a = this.active.next(), l = {
                        options: i,
            ...
            if (o._trigger("changestart", null, o.data), o.running = 0 === e.size() ? t.size() : e.size(), r.animated) {
                ...
                var h = d.ui.accordion.animations, c = r.duration, u = r.animated;
        ...
        version: "1.8.22", animations: {
            slide: function (s, t) {
                if ((s = d.extend({easing: "swing", duration: 300}, s, t)).toHide.size()) if (s.toShow.size()) {
                    var e, i = s.toShow.css("overflow"), n = 0, o = {}, r = {}, a = s.toShow;
                    ...
                    paddingTop: "hide",
                    paddingBottom: "hide"
                }, s); else s.toShow.animate({height: "show", paddingTop: "show", paddingBottom: "show"}, s)
    ...
    n.widget("ui.menu", {
        _create: function () {
            ...
            if (this.deactivate(), this.hasScroll()) {
                var i = e.offset().top - this.element.offset().top, s = this.element.scrollTop(),
    ...
    o.widget("ui.button", {
        ...
        _determineButtonType: function () {
            if (this.element.is(":checkbox") ? this.type = "checkbox" : this.element.is(":radio") ? this.type = "radio" : this.element.is("input") ? this.type = "input" : this.type = "button", "checkbox" === this.type || "radio" === this.type) {
                var t = this.element.parents().filter(":last"), e = "label[for='" + this.element.attr("id") + "']";
        ...
        _resetButton: function () {
            if ("input" !== this.type) {
                var t = this.buttonElement.removeClass(u),
                    ...
                    i = this.options.icons, s = i.primary && i.secondary, n = [];
    ...
    $.extend(Datepicker.prototype, {
        ...
        _dialogDatepicker: function (t, e, i, s, n) {
            ...
            if (extendRemove(o.settings, s || {}), e = e && e.constructor == Date ? this._formatDate(o, e) : e, this._dialogInput.val(e), this._pos = n ? n.length ? n : [n.pageX, n.pageY] : null, !this._pos) {
                var a = document.documentElement.clientWidth, l = document.documentElement.clientHeight,
        ...
        _optionDatepicker: function (t, e, i) {
            ...
            if ("string" == typeof e && ((n = {})[e] = i), s) {
                ...
                var o = this._getDateDatepicker(t, !0), r = this._getMinMaxDate(s, "min"),
        ...
        _showDatepicker: function (t) {
            if ("input" != (t = t.target || t).nodeName.toLowerCase() && (t = $("input", t.parentNode)[0]), !$.datepicker._isDisabledDatepicker(t) && $.datepicker._lastInput != t) {
                ...
                var e = $.datepicker._get(i, "beforeShow"), s = e ? e.apply(t, [t, i]) : {};
                if (!1 !== s) {
                    ...
                    if ($.datepicker._pos = null, i.dpDiv.empty(), i.dpDiv.css({
                        ...
                        var r = $.datepicker._get(i, "showAnim"), a = $.datepicker._get(i, "duration"),
                            l = function () {
        ...
        _updateDatepicker: function (t) {
            ...
            var s = this._getNumberOfMonths(t), n = s[1];
        ...
        parseDate: function (i, o, t) {
            ...
            for (var s = (t ? t.dayNamesShort : null) || this._defaults.dayNamesShort, n = (t ? t.dayNames : null) || this._defaults.dayNames, r = (t ? t.monthNamesShort : null) || this._defaults.monthNamesShort, a = (t ? t.monthNames : null) || this._defaults.monthNames, l = -1, h = -1, c = -1, u = -1, d = !1, p = function (t) {
                ...
                v++
            }, v = 0, _ = 0; _ < i.length; _++) if (d) "'" != i.charAt(_) || p("'") ? m() : d = !1; else switch (i.charAt(_)) {
                case"d":
                    c = f("d");
                    break;
                case"D":
            ...
            if (-1 == l ? l = (new Date).getFullYear() : l < 100 && (l += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (l <= e ? 0 : -100)), -1 < u) for (h = 1, c = u; ;) {
        ...
        formatDate: function (i, t, e) {
            ...
            var s = (e ? e.dayNamesShort : null) || this._defaults.dayNamesShort,
                ...
                r = (e ? e.monthNames : null) || this._defaults.monthNames, a = function (t) {
            ...
            if (t) for (var d = 0; d < i.length; d++) if (u) "'" != i.charAt(d) || a("'") ? c += i.charAt(d) : u = !1; else switch (i.charAt(d)) {
                case"d":
                    c += l("d", t.getDate(), 2);
                    break;
                case"D":
        ...
        _possibleChars: function (i) {
            for (var t = "", e = !1, s = function (t) {
                ...
                return e && n++, e
            }, n = 0; n < i.length; n++) if (e) "'" != i.charAt(n) || s("'") ? t += i.charAt(n) : e = !1; else switch (i.charAt(n)) {
                case"d":
                case"m":
                case"y":
                case"@":
        ...
        _generateHTML: function (t) {
            ...
            for (var k = this._get(t, "showWeek"), E = this._get(t, "dayNames"), I = (this._get(t, "dayNamesShort"), this._get(t, "dayNamesMin")), S = this._get(t, "monthNames"), T = this._get(t, "monthNamesShort"), A = this._get(t, "beforeShowDay"), P = this._get(t, "showOtherMonths"), F = this._get(t, "selectOtherMonths"), M = (this._get(t, "calculateWeek") || this.iso8601Week, this._getDefaultDate(t)), N = "", O = 0; O < r[0]; O++) {
                ...
                this.maxRows = 4;
                for (var H = 0; H < r[1]; H++) {
                    var W = this._daylightSavingAdjust(new Date(f, p, t.selectedDay)), L = " ui-corner-all", R = "";
                    if (h) {
                    ...
                    var K = (this._getFirstDayOfMonth(f, p) - x + 7) % 7, U = Math.ceil((K + Y) / 7),
                    ...
                    for (var V = this._daylightSavingAdjust(new Date(f, p, 1 - K)), X = 0; X < Q; X++) {
                        ...
                        for (q = 0; q < 7; q++) {
                            var G = A ? A.apply(t.input ? t.input[0] : null, [V]) : [!0, ""], J = V.getMonth() != p,
        ...
        _generateMonthYearHeader: function (t, e, i, s, n, o, r, a) {
            ...
            if (c || (u += d + (!o && l && h ? "" : "&#xa0;")), !t.yearshtml) if (t.yearshtml = "", o || !h) u += '<span class="ui-datepicker-year">' + i + "</span>"; else {
                var m = this._get(t, "yearRange").split(":"), v = (new Date).getFullYear(), _ = function (t) {
    ...
    a.widget("ui.dialog", {
        options: {
            ...
            var t, e, i = this.options, s = this.uiDialog.is(":visible");
            if (this.element.show().css({
                    ...
                    height: "auto",
                    width: i.width
                }).height(), e = Math.max(0, i.minHeight - t), "auto" === i.height) if (a.support.minHeight) this.element.css({
                minHeight: e,
                height: "auto"
            }); else {
                this.uiDialog.show();
    ...
    g.fn.position = function (h) {
        ...
        h = g.extend({}, h);
        var c, u, d, t = g(h.of), e = t[0], p = (h.collision || "flip").split(" "),
        ...
        return 9 === e.nodeType ? (c = t.width(), u = t.height(), d = {
            ...
            var i, t = g(this), s = t.outerWidth(), n = t.outerHeight(),
                ...
                a = n + o + (parseInt(g.curCSS(this, "marginBottom", !0)) || 0), l = g.extend({}, d);
            ...
            left: function (t, e) {
                if (e.at[0] !== m) {
                    var i = g(window), s = e.collisionPosition.left + e.collisionWidth - i.width() - i.scrollLeft(),
                        ...
                        o = "left" === e.at[0] ? e.targetWidth : -e.targetWidth, r = -2 * e.offset[0];
                ...
                if (e.at[1] !== m) {
                    var i = g(window), s = e.collisionPosition.top + e.collisionHeight - i.height() - i.scrollTop(),
                        ...
                        o = "top" === e.at[1] ? e.targetHeight : -e.targetHeight, r = -2 * e.offset[1];
        ...
        var t, e, i, s, n, o = document.getElementsByTagName("body")[0], r = document.createElement("div");
        for (var a in t = document.createElement(o ? "div" : "body"), i = {
            ...
            margin: 0,
            background: "none"
        }, o && g.extend(i, {position: "absolute", left: "-1000px", top: "-1000px"}), i) t.style[a] = i[a];
    ...
    p.widget("ui.tabs", {
        options: {
            ...
            var s, n, a = this, l = this.options, h = /^#.+/;
            this.list = this.element.find("ol,ul").eq(0), this.lis = p(" > li:has(a[href])", this.list), this.anchors = this.lis.map(function () {
                ...
                var i, s = p(e).attr("href"), n = s.split("#")[0];
                if (n && (n === location.toString().split("#")[0] || (i = p("base")[0]) && n === i.href) && (s = e.hash, e.href = s), h.test(s)) a.panels = a.panels.add(a.element.find(a._sanitizeSelector(s))); else if (s && "#" !== s) {
            ...
            s = this._getIndex(s);
            var n = this, o = this.options, r = this.anchors.eq(s)[0], t = p.data(r, "load.tabs");
    ...
    var r = 0, l = {}, a = {}, h = Array.prototype.slice, d = function (t) {
        return u.isArray(t) ? t : [t]
    }, n = "disabled", p = "wizard", f = "default", g = "number", m = "boolean";
    u.each("branch form header step wrapper".split(" "), function () {
        ...
        _transition: function (t, e, i) {
            ...
            var n, o = s.options, r = s.step(t, e), a = r.attr(o.stateAttribute),
                ...
                return e[r.name] = o, h.ajax(h.extend(!0, {
                    ...
                    success: function (t) {
                        ...
                        if (e) {
                            ...
                            var s = {}, n = t || l.defaultMessage(r, "remote");
    ...
    o.fn.niceSelect = function (t) {
        if ("string" == typeof t) return "update" == t ? this.each(function () {
            var t = o(this), e = o(this).next(".nice-select"), i = e.hasClass("open");
            e.length && (e.remove(), s(t), i && t.next().trigger("click"))
        }) : "destroy" == t ? (this.each(function () {
            var t = o(this), e = o(this).next(".nice-select");
        ...
        function s(t) {
            ...
            var s = t.next(), e = t.find("option"), i = t.find("option:selected");
            s.find(".current").html(i.data("display") || i.text()), e.each(function (t) {
                var e = o(this), i = e.data("display");
        ...
        this.hide(), this.each(function () {
            ...
            var e = o(this), i = e.closest(".nice-select");
            ...
            var e = o(this), i = o(e.find(".focus") || e.find(".list .option.selected"));
    ...
    var t, r = "rangeslider", a = 0,
        l = ((t = document.createElement("input")).setAttribute("type", "range"), "text" !== t.type), h = {
            polyfill: !0,
            orientation: "horizontal",
    ...
    function i(t, e) {
        var i = function (t) {
            for (var e, i = [], s = t.parentNode; (e = s) && (0 === e.offsetWidth || 0 === e.offsetHeight || !1 === e.open);) i.push(s), s = s.parentNode;
            return i
        }(t), s = i.length, n = [], o = t[e];
    ...
    function u(t, e) {
        ...
        this.$window.on("resize." + this.identifier, (i = function () {
            ...
            if (!e || e.origin !== n.identifier) {
                var i = t.target.value, s = n.getPositionFromValue(i);
                n.setPosition(s)
            }
        })
    }
    ...
    return u.prototype.init = function () {
        ...
        if (t.preventDefault(), this.$document.on(this.moveEvent, this.handleMove), this.$document.on(this.endEvent, this.handleEnd), this.$range.addClass(this.options.activeClass), !(-1 < (" " + t.target.className + " ").replace(/[\n\t]/g, " ").indexOf(this.options.handleClass))) {
            var e = this.getRelativePosition(t), i = this.$range[0].getBoundingClientRect()[this.DIRECTION],
        ...
        var e = n(this.COORDINATE), i = this.$range[0].getBoundingClientRect()[this.DIRECTION], s = 0;
        ...
        return this.each(function () {
            var t = o(this), e = t.data("plugin_" + r);
